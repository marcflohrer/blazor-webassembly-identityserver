...
FROM mcr.microsoft.com/dotnet/runtime-deps:7.0-bookworm-slim AS base
WORKDIR /app
...
RUN dotnet publish "Server/BlazorWasm.Server.csproj" -c Release -o /app/Server/publish --runtime linux-x64 --self-contained  true && chmod +x /app/Server/publish/BlazorWasm.Server
